...
def game_loop(speed, player1_color, player2_color, background_color, player_1_name, player_2_name):
    ...
    while True:
        ...
        try:
            ...
            #if limit_record%1 == 0: #Chose with %i if you want to read the data at each iteration or less (Image too slow if we take a measure at each iteration)
            if True:
                ...
                if(ser.in_waiting == 0):
                    ...
                    if read_bytes.decode() == 'd':
                        ...
                        if entier_c > 1500 and entier_c < 4000:
                            w,s,d,a = True,False,False,False
                        else:
                            w,s,d,a = False,True,False,False
        ...
        print(" limit record = ", limit_record)
