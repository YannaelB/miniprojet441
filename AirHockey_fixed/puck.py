...
class Puck:
    def __init__(self, x, y):
        ...
        self.angle = rand.uniform(-math.pi, math.pi)
        while self.angle == 0:
            self.angle = rand.uniform(-math.pi, math.pi)
    ...
    def collision_paddle(self, paddle):
        ...
        (self.angle, self.speed) = self.add_vectors(vec_a[0],vec_a[1],vec_b[0], vec_b[1])
        ...
        (paddle.angle, paddle.speed) = self.add_vectors(vec_a[0],vec_a[1],vec_b[0], vec_b[1])
    ...
    def round_reset(self, player):
        ...
        while self.angle == 0:
            self.angle = rand.uniform(-math.pi, math.pi)
        self.speed = const.PUCK_SPEED
        #print(" PUCK round reset self.angle = ", self.angle)
    ...
    def reset(self, speed, player):
        ...
        self.y = const.HEIGHT / 2
        #print(" PUCK reset self.angle = ", self.angle)

    def end_reset(self, speed):
        self.angle = rand.uniform(-math.pi, math.pi)
        while self.angle == 0:
            self.angle = rand.uniform(-math.pi, math.pi)
            #print(" PUCK end reset self.angle = ", self.angle)
        self.speed = speed
        self.x = const.WIDTH / 2
        self.y = const.HEIGHT / 2
